    ...
    <section className="container content" style={{marginBottom: 20}}>
        ...
        <div className="row">
          <div className="col-md-4">
            ...
            If DJ services are required, then we will set up the necessary equipment that we own and then play the music requested for the event.</p>
          </div>
          <div className="col-md-4">
        ...
        <div className="row">
          <div className="col-md-4">
            ...
            <p>Learn the basics of guitar playing every Saturday from 3:00pm to 5:00pm. These free lessons will get you started on electric or acoustic guitar.</p>
          </div>
          <div className="col-md-4">
            <h3>Production Lessons</h3>
            <Img fluid={data.productionLessons.childImageSharp.fluid} className="services-pic" />
            <p>Learn to produce your own music every Saturday from 2:00pm to 3:00pm. You'll have access to our expansive program collection and equipment.</p>
          </div>
          <div className="col-md-4">
